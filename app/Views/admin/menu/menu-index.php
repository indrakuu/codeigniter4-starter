...
<link rel="stylesheet" href="<?= base_url('assets/libs/fontawesome-iconpicker/css/fontawesome-iconpicker.min.css') ?>">
<style>
...
<script src="<?= base_url('assets/libs/jquery-nestable/jquery.nestable.min.js') ?>"></script>
<script src="<?= base_url('assets/libs/select2/dist/js/select2.min.js') ?>"></script>
<script src="<?=base_url('assets/libs/fontawesome-iconpicker/js/fontawesome-iconpicker.min.js')?>"></script>
