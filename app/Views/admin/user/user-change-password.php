...
<div class="container-fluid">
  ...
  <div class="row">
      <div class="col-lg-12">
        <div class="card mb-4">
          <form action="<?= route_to('user.updatePassword', $data->id) ?>" method="post">
            <div class="card-header">
              <h5 class="mb-0">Update New Password</h5>
            </div>
            <div class="card-body">
            ...
            <div class="card-footer text-end">
              <div class="d-flex justify-content-between">
                <a href="<?= route_to('user.show', $data->id) ?>" class="btn btn-sm btn-secondary">
